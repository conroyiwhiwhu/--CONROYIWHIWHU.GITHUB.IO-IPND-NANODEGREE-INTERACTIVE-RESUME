...
(function(window, undefined) {
    ...
    jQuery.extend({
        ...
        expando: "jQuery" + (core_version + Math.random()).replace(
            /\D/g, ""),
        ...
        type: function(obj) {
            ...
            return typeof obj === "object" || typeof obj ===
                "function" ? class2type[core_toString.call(obj)] ||
                "object" : typeof obj;
        },
        ...
        inArray: function(elem, arr, i) {
            return arr == null ? -1 : core_indexOf.call(arr,
                elem, i);
        },
    ...
    (function(window, undefined) {
        ...
        function siblingCheck(a, b) {
            var cur = b && a,
                ...
                (~b.sourceIndex || MAX_NEGATIVE) - (~a.sourceIndex ||
                    MAX_NEGATIVE);
  ...
  ---------------------------------------------------------------------- */
            ...
            support.getElementsByClassName = assert(function(div) {
                ...
                return div.getElementsByClassName("i").length ===
                    2;
            });
            // Support: IE<10
  ...
  ---------------------------------------------------------------------- */
            ...
            sortOrder = docElem.compareDocumentPosition ? function(
                ...
                if (a === b) {
                    ...
                    return a === doc ? -1 : b === doc ? 1 : aup ?
                        -1 : bup ? 1 : sortInput ? (indexOf.call(
                            sortInput, a) - indexOf.call(
                            sortInput, b)) : 0;
        ...
        Sizzle.attr = function(elem, name) {
            ...
            return val === undefined ? support.attributes || !
                documentIsHTML ? elem.getAttribute(name) : (val =
      ...
      */
                ...
                "ATTR": function(name, operator, check) {
                    return function(elem) {
                        ...
                        return operator === "=" ? result ===
                            ...
                            -1 : operator === "|=" ? result ===
                            check || result.slice(0, check.length +
                                1) === check + "-" : false;
                    };
                },
                ...
                "PSEUDO": function(pseudo, argument) {
                    ...
                    var args,
                        fn = Expr.pseudos[pseudo] || Expr.setFilters[
                            pseudo.toLowerCase()] || Sizzle.error(
            ...
            pseudos: {
                ...
                "lang": markFunction(function(lang) {
                    ...
                    return function(elem) {
                        ...
                        do {
                            if ((elemLang =
                                    documentIsHTML ?
                                    elem.lang : elem.getAttribute(
                                        "xml:lang") ||
                                    elem.getAttribute(
                                        "lang"))) {
                                elemLang = elemLang.toLowerCase();
                                return elemLang ===
                                    lang || elemLang.indexOf(
                                        lang + "-") ===
                                    0;
                            }
                ...
                "target": function(elem) {
                    var hash = window.location && window.location
                        .hash;
                ...
                "empty": function(elem) {
                    ...
                    for (elem = elem.firstChild; elem; elem =
                        elem.nextSibling) {
                        if (elem.nodeName > "@" || elem.nodeType ===
                            3 || elem.nodeType === 4) {
                            return false;
                        }
                    }
        ...
        function tokenize(selector, parseOnly) {
            ...
            return parseOnly ? soFar.length : soFar ? Sizzle.error(
                    selector) :
                // Cache the tokens
            ...
            return markFunction(function(seed, results, context,
                ...
                var temp, i, elem,
                    ...
                    matcherIn = preFilter && (seed || !
                        selector) ? condense(elems, preMap,
        ...
        function matcherFromTokens(tokens) {
            var checkContext, matcher, j,
                ...
                matchAnyContext = addCombinator(function(elem) {
                    return indexOf.call(checkContext, elem) > -
                        1;
                }, implicitRelative, true),
                matchers = [
                    function(elem, context, xml) {
            ...
            for (; i < len; i++) {
                if ((matcher = Expr.relative[tokens[i].type])) {
                    ...
                    if (matcher[expando]) {
                        ...
                        return setMatcher(i > 1 && elementMatcher(
                                matchers), i > 1 && toSelector(
                                // If the preceding token was a descendant combinator, insert an implicit any-element `*`
                                tokens.slice(0, i - 1).concat({
                                    value: tokens[i - 2].type ===
                                        " " ? "*" : ""
                                })).replace(rtrim, "$1"),
                            matcher, i < j && matcherFromTokens(
                                tokens.slice(i, j)), j < len &&
                            matcherFromTokens((tokens = tokens.slice(
                                j))), j < len && toSelector(
                                tokens));
                    }
                ...
                superMatcher = function(seed, context, xml, results,
                    ...
                    var elem, j, matcher,
                        ...
                        elems = seed || byElement && Expr.find[
                            "TAG"]("*", expandContext && context.parentNode ||
                            context),
                    ...
                    if (bySet && i !== matchedCount) {
                        ...
                        if (outermost && !seed && setMatched.length >
                            0 && (matchedCount + setMatchers.length) >
                            1) {
            ...
            if (!seed) {
                ...
                if (match.length === 1) {
                    ...
                    if (tokens.length > 2 && (token = tokens[0]).type ===
                        "ID" && support.getById && context.nodeType ===
                        9 && documentIsHTML && Expr.relative[tokens[
                            1].type]) {
                        ...
                        selector = selector.slice(tokens.shift().value
                            .length);
                    }
            ...
            addHandle(booleans, function(elem, name, isXML) {
                ...
                if (!isXML) {
                    return (val = elem.getAttributeNode(name)) &&
                        val.specified ? val.value : elem[name] ===
    ...
    jQuery.support = (function(support) {
        ...
        jQuery(function() {
            ...
            jQuery.swap(body, body.style.zoom != null ? {
                ...
                support.boxSizing = div.offsetWidth ===
                    4;
            });
            ...
            if (window.getComputedStyle) {
                ...
                marginDiv.style.cssText = div.style.cssText =
                    divReset;
                marginDiv.style.marginRight = marginDiv.style
                    .width = "0";
                div.style.width = "1px";
...
*/
    ...
    Data.accepts = function(owner) {
        ...
        //  - Object
        //    - Any
        return owner.nodeType ? owner.nodeType === 1 || owner.nodeType ===
            9 : true;
    };
    Data.prototype = {
        key: function(owner) {
            ...
            if (proceed) {
                ...
                for (; i < len; i++) {
                    ...
                    if (cur) {
                        ...
                        elem.className = value ? jQuery.trim(
                            cur) : "";
                    }
                }
            }
    ...
    jQuery.extend({
        ...
        attr: function(elem, name, value) {
            ...
            if (nType !== 1 || !jQuery.isXMLDoc(elem)) {
                ...
                hooks = jQuery.attrHooks[name] || (jQuery.expr.match
                    .bool.test(name) ? boolHook : nodeHook);
            }
            if (value !== undefined) {
                if (value === null) {
        ...
        attrHooks: {
            type: {
                set: function(elem, value) {
                    if (!jQuery.support.radioValue && value ===
        ...
        prop: function(elem, name, value) {
            ...
            if (value !== undefined) {
                return hooks && "set" in hooks && (ret = hooks.set(
                        elem, value, name)) !== undefined ? ret :
                    (elem[name] = value);
            } else {
                return hooks && "get" in hooks && (ret = hooks.get(
                    elem, name)) !== null ? ret : elem[name];
            }
        },
        propHooks: {
            tabIndex: {
    ...
    jQuery.event = {
            ...
            if (!(eventHandle = elemData.handle)) {
                eventHandle = elemData.handle = function(e) {
                    ...
                    return typeof jQuery !== core_strundefined &&
                        ...
                        jQuery.event.dispatch.apply(eventHandle
        ...
        trigger: function(event, data, elem, onlyHandlers) {
            var i, cur, tmp, bubbleType, ontype, handle, special,
                ...
                type = core_hasOwn.call(event, "type") ? event.type :
                event,
            ...
            while ((cur = eventPath[i++]) && !event.isPropagationStopped()) {
                event.type = i > 1 ? bubbleType : special.bindType ||
                    type;
                // jQuery handler
                handle = (data_priv.get(cur, "events") || {})[event
                    .type] && data_priv.get(cur, "handle");
                if (handle) {
            ...
            if (!onlyHandlers && !event.isDefaultPrevented()) {
                if ((!special._default || special._default.apply(
                        eventPath.pop(), data) === false) && jQuery
                    .acceptData(elem)) {
            ...
            filter: function(event, original) {
                ...
                if (event.pageX == null && original.clientX != null) {
                    ...
                    event.pageX = original.clientX + (doc && doc.scrollLeft ||
                        ...
                        doc.clientLeft || body && body.clientLeft ||
                        0);
                    event.pageY = original.clientY + (doc && doc.scrollTop ||
                        body && body.scrollTop || 0) - (doc &&
                        doc.clientTop || body && body.clientTop ||
                        0);
                }
        ...
        jQuery.each({
            ...
            var attaches = 0,
                handler = function(event) {
                    jQuery.event.simulate(fix, event.target, jQuery
                        .event.fix(event), true);
                };
            ...
            for (; i < l; i++) {
                for (cur = this[i]; cur && cur !== context; cur =
                    ...
                    if (cur.nodeType < 11 && (pos ? pos.index(
                            ...
                            cur.nodeType === 1 && jQuery.find.matchesSelector(
                                cur, selectors))) {
    ...
    function winnow(elements, qualifier, not) {
        ...
        return jQuery.grep(elements, function(elem) {
            return (core_indexOf.call(qualifier, elem) >= 0) !==
                not;
        });
    }
    var rxhtmlTag =
    ...
    jQuery.fn.extend({
        text: function(value) {
            return jQuery.access(this, function(value) {
                return value === undefined ? jQuery.text(
        ...
        domManip: function(args, callback, allowIntersection) {
            ...
            if (isFunction || !(l <= 1 || typeof value !==
                    "string" || jQuery.support.checkClone || !
                    rchecked.test(value))) {
    ...
    function manipulationTarget(elem, content) {
        return jQuery.nodeName(elem, "table") && jQuery.nodeName(
            ...
            "tr") ? elem.getElementsByTagName("tbody")[0] || elem.appendChild(
    ...
    function fixInput(src, dest) {
        ...
        if (nodeName === "input" && manipulation_rcheckableType.test(
                src.type)) {
    ...
    jQuery.fn.extend({
        css: function(name, value) {
            return jQuery.access(this, function(elem, name,
                value) {
                var styles, len,
                    map = {},
                    i = 0;
                ...
                return value !== undefined ? jQuery.style(
                    elem, name, value) : jQuery.css(
                    elem, name);
            ...
            set: function(elem, value, extra) {
                ...
                return setPositiveNumber(elem, value, extra ?
                    augmentWidthOrHeight(elem, name,
                        extra, jQuery.support.boxSizing &&
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                return this.name && !jQuery(this).is(
                        ":disabled") && rsubmittable.test(
                        this.nodeName) && !
                    rsubmitterTypes.test(type) && (this
                        .checked || !
    ...
    */
        ...
        ajax: function(url, options) {
            ...
            var transport,
                ...
                globalEventContext = s.context && (
                    ...
                    .jquery) ? jQuery(callbackContext) : jQuery
                .event,
                // Deferreds
            ...
            // Attach deferreds
            deferred.promise(jqXHR).complete = completeDeferred
                .add;
            ...
            s.url = ((url || s.url || ajaxLocation) + "").replace(
                rhash, "").replace(rprotocol, ajaxLocParts[
                1] + "//");
            ...
            if (!s.hasContent) {
                ...
                if (s.data) {
                    cacheURL = (s.url += (ajax_rquery.test(
                        cacheURL) ? "&" : "?") + s.data);
            ...
            return {
                send: function(_, complete) {
                    script = jQuery("<script>").prop({
                        ...
                        src: s.url
                    }).on("load error", callback = function(
                        evt) {
                        script.remove();
                        callback = null;
                        if (evt) {
        ...
        if (jQuery.support.cors || xhrSupported && !options.crossDomain) {
            return {
                send: function(headers, complete) {
                    var i, id,
                        xhr = options.xhr();
                    xhr.open(options.type, options.url, options
                    ...
                    callback = xhrCallbacks[(id = xhrId++)] =
                        callback("abort");
                    // Do send the request
            ...
            animation = deferred.promise({
                ...
                createTween: function(prop, end) {
                    var tween = jQuery.Tween(elem, animation.opts,
                        prop, end, animation.opts.specialEasing[
    ...
    function defaultPrefilter(elem, props, opts) {
        ...
        if (elem.nodeType === 1 && ("height" in props || "width" in
            ...
            if (jQuery.css(elem, "display") === "inline" && jQuery.css(
                    elem, "float") === "none") {
    ...
    Tween.prototype = {
        ...
        cur: function() {
            ...
            return hooks && hooks.get ? hooks.get(this) : Tween.propHooks
                ._default.get(this);
        },
        run: function(percent) {
            ...
            if (this.options.duration) {
                this.pos = eased = jQuery.easing[this.easing](
                    percent, this.options.duration * percent, 0,
    ...
    Tween.propHooks = {
        _default: {
            get: function(tween) {
                var result;
                if (tween.elem[tween.prop] != null && (!tween.elem.style ||
    ...
    jQuery.each(["toggle", "show", "hide"], function(i, name) {
        ...
        jQuery.fn[name] = function(speed, easing, callback) {
            return speed == null || typeof speed === "boolean" ?
                cssFn.apply(this, arguments) : this.animate(
    ...
    jQuery.each({
        ...
        jQuery.fn[method] = function(val) {
            return jQuery.access(this, function(elem, method,
                val) {
